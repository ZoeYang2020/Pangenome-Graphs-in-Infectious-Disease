...
mkdir simu_random_SNPs_2K_8genomes2k_3
...
perl simuG.pl -refseq ${x}.fa -snp_count 2000 -prefix ${x}_2k_3 

cat ${x}_2k_3.simseq.genome.fa |sed 's/'${x}'/'${x}_2k_3'/g' >${x}_2k_3.fa 


mv ${x}_2k_3* ./simu_random_SNPs_2K_8genomes2k_3

cd  ./simu_random_SNPs_2K_8genomes2k_3 
#mv ${x}_2k_3.simseq.genome.fa ${x}_2k_3.fa
rm ${x}_2k_3.simseq.genome.fa 
mv ${x}_2k_3.refseq2simseq.map.txt ${x}_2k_3.map.txt
mv ${x}_2k_3.refseq2simseq.SNP.vcf ${x}_2k_3.snp.vcf 
