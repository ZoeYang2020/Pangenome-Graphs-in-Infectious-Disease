...
mkdir simu_random_SNPs_2K_8genomes2k_5
...
perl simuG.pl -refseq ${x}.fa -snp_count 2000 -prefix ${x}_2k_5 

cat ${x}_2k_5.simseq.genome.fa |sed 's/'${x}'/'${x}_2k_5'/g' >${x}_2k_5.fa 


mv ${x}_2k_5* ./simu_random_SNPs_2K_8genomes2k_5

cd  ./simu_random_SNPs_2K_8genomes2k_5 
#mv ${x}_2k_5.simseq.genome.fa ${x}_2k_5.fa
rm ${x}_2k_5.simseq.genome.fa 
mv ${x}_2k_5.refseq2simseq.map.txt ${x}_2k_5.map.txt
mv ${x}_2k_5.refseq2simseq.SNP.vcf ${x}_2k_5.snp.vcf 
