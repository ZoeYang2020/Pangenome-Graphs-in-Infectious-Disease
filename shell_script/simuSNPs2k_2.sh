...
mkdir simu_random_SNPs_2K_8genomes2k_2
...
perl simuG.pl -refseq ${x}.fa -snp_count 2000 -prefix ${x}_2k_2 

cat ${x}_2k_2.simseq.genome.fa |sed 's/'${x}'/'${x}_2k_2'/g' >${x}_2k_2.fa 


mv ${x}_2k_2* ./simu_random_SNPs_2K_8genomes2k_2

cd  ./simu_random_SNPs_2K_8genomes2k_2 
#mv ${x}_2k_2.simseq.genome.fa ${x}_2k_2.fa
rm ${x}_2k_2.simseq.genome.fa 
mv ${x}_2k_2.refseq2simseq.map.txt ${x}_2k_2.map.txt
mv ${x}_2k_2.refseq2simseq.SNP.vcf ${x}_2k_2.snp.vcf 
