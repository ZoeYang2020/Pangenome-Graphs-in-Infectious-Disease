...
mkdir simu_random_SNPs_2K_8genomes2k_1
...
perl simuG.pl -refseq ${x}.fa -snp_count 2000 -prefix ${x}_2k_1 

cat ${x}_2k_1.simseq.genome.fa |sed 's/'${x}'/'${x}_2k_1'/g' >${x}_2k_1.fa 


mv ${x}_2k_1* ./simu_random_SNPs_2K_8genomes2k_1

cd  ./simu_random_SNPs_2K_8genomes2k_1 
#mv ${x}_2k_1.simseq.genome.fa ${x}_2k_1.fa
rm ${x}_2k_1.simseq.genome.fa 
mv ${x}_2k_1.refseq2simseq.map.txt ${x}_2k_1.map.txt
mv ${x}_2k_1.refseq2simseq.SNP.vcf ${x}_2k_1.snp.vcf 
